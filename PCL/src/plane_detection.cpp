...
// Sample file and parammeters to run 
//  ./detect_plane ../lib/crate_detection_pointclouds/sample0.pcd 0 1.0 -0.5 0.5 0.01 0.02 50 5000
...
int main(int argc, char **argv)
{
    ...
    std::cout << "the PCL version "<<PCL_VERSION << std::endl;
